                            ...
                            <div className='first-section'>
                                ...
                                <div className='education-values'>
                                    <motion.div className='bachelors' whileHover={{ scale: 1.125 }}>
                                        ...
                                        <p className='info'><i className="fa fa-clock-o" aria-hidden="true"></i>&emsp;2018-2022</p>
                                        <p className='info'><i className="fa fa-university" aria-hidden="true"></i>&emsp;SRM Institute of Science and Technology</p>
                                    </motion.div>
                                    <motion.div className='senior-secondary' whileHover={{ scale: 1.125 }}>
                                        <h3 className='degree'>Higher Secondary</h3>
                                        <p className='info'><i className="fa fa-clock-o" aria-hidden="true"></i>&emsp;2016-2017</p>
                                        <p className='info'><i className="fa fa-university" aria-hidden="true"></i>&emsp;Prabhat Public School</p>
                                    </motion.div>
                                    <motion.div className='high-school' whileHover={{ scale: 1.125 }}>
                                        <h3 className='degree'>High School</h3>
                                        <p className='info'><i className="fa fa-clock-o" aria-hidden="true"></i>&emsp;2014-2015</p>
                                        <p className='info'><i className="fa fa-university" aria-hidden="true"></i>&emsp;Swaraj India Public School</p>
                                    </motion.div>
                                </div>
                            </div>
                            <div className='second-section'>
                                ...
                                <div className='experience-values'>
                                    <motion.div className='job-role' whileHover={{ scale: 1.125 }}>
                                        ...
                                        <p className='info'><i className="fa fa-clock-o" aria-hidden="true"></i>&emsp;2022-Now</p>
                                        <p className='info'><i className="fa fa-building" aria-hidden="true"></i>&emsp;Merkle Inspire</p>
                                    </motion.div>
                                    <motion.div className='job-role2' whileHover={{ scale: 1.125 }}>
                                        <h3 className='job'>UI Automation Developer</h3>
                                        <p className='info'><i className="fa fa-clock-o" aria-hidden="true"></i>&emsp;2021-2022</p>
                                        <p className='info'><i className="fa fa-building" aria-hidden="true"></i>&emsp;HighRadius Technologies Pvt Ltd</p>
                                    </motion.div>
                                </div>
                            </div>
                        </div>
