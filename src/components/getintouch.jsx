                    ...
                    <div className='col-sm-12 col-md-9 getintouch-values'>
                        <div className='first-contact'>
                            <motion.div className='phone' whileHover={{ scale: 1.15 }}>
                                <i class="fa fa-phone connect-icon" aria-hidden="true"></i>
                                <p>
                            ...
                            <motion.div className='address' whileHover={{ scale: 1.15 }}>
                                <i class="fa fa-map-marker connect-icon" aria-hidden="true"></i>
                                <p>
                        ...
                        <div className='second-contact'>
                            <motion.div className='email' whileHover={{ scale: 1.15 }}>
                                <i class="fa fa-envelope-o connect-icon" aria-hidden="true"></i>
                                <p>
                            ...
                            <motion.div className='new-connections' whileHover={{ scale: 1.15 }}>
                                <i class="fa fa-share-alt connect-icon" aria-hidden="true"></i>
                                <p>
                                    <span className='small-text'>Let's Connect</span>
                                    <span>
                                        <a href="https://www.linkedin.com/in/mohd-sahil-siddiqui-021a11201/" target='_blank' className='text-white'><i class="fa fa-linkedin" aria-hidden="true"></i></a>
                                    </span>
                                </p>
                            </motion.div>
                        </div>
